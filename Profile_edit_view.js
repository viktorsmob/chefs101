...
import MyStorage from './Lib/localStorage.service'
...
export default class Profile_edit_view extends Component { 
  state = {
    trueSwitchIsOn: true,
  ...
  async loadUserInfo()
  {
    var userinfo = await MyStorage.getObject('userinfo');
        ...
        <Image style ={styles.container}
          ...
          <ScrollView style={{height: windowHeight/8, backgroundColor: 'rgb(223,201,222)'}}>
              <View style={{paddingLeft: 20, flexDirection: 'row', flex: 1, height: windowHeight / 6,  borderBottomColor: 'rgb(162,27,70)',borderWidth:0, borderBottomWidth: 5,alignItems: 'center', justifyContent: 'center'}}>
                    <Image style ={{left:0, flex:1,height: windowHeight/6,backgroundColor: 'transparent'}} source={{uri: this.state.data.image}} resizeMode={Image.resizeMode.contain}/>
                    <View style={{flexDirection: 'column', flex: 3, height: windowHeight / 6}}>
                      <View style={{flexDirection: 'row', flex:1}}>
                        <Image style ={{left:0, flex:1,height: windowHeight/12,backgroundColor: 'transparent'}} source={require('./img/epusername_icon.png')} resizeMode={Image.resizeMode.contain}/>
                        <TextInput value={this.state.data.name} style={[{paddingLeft: 5, flex: 8, backgroundColor: 'transparent',borderWidth: 0, fontSize: windowHeight/35}]}   onChangeText={(txt) => { _username = txt;}} placeholder="Name"/>
                      </View>
                      <View style={{flexDirection: 'row', flex:1}}>
                        ...
                        <TextInput value={this.state.data.username} style={[{paddingLeft: 5, flex: 8, backgroundColor: 'transparent',borderWidth: 0, fontSize: windowHeight/35}]}   onChangeText={(txt) => { _username = txt;}} placeholder="Username"/>
                      </View>
                    </View>
              </View>
              <View style={{paddingLeft: 5, justifyContent: 'center', alignItems:'center',flexDirection: 'row', flex: 1, borderBottomColor: 'rgb(162,27,70)',borderWidth:0, borderBottomWidth: 2, height: windowHeight/6}}>
                    ...
                    <TextInput value={this.state.data.bio} placeholder="Bio" multiline = {true} style={[{paddingLeft: 5, flex: 8, backgroundColor: 'transparent',borderWidth: 0, fontSize: windowHeight/35}]}  onChangeText={(txt) => { _username = txt;}}/>
              </View>
              <View style={{paddingLeft: 5, justifyContent: 'center', alignItems:'center',flexDirection: 'row', flex: 1, borderBottomColor: 'rgb(162,27,70)',borderWidth:0, borderBottomWidth: 2, height: windowHeight/12}}>
                    ...
                    <TextInput value={this.state.data.email} placeholder="Email" style={[{paddingLeft: 5, flex: 8, backgroundColor: 'transparent',borderWidth: 0, fontSize: windowHeight/35}]}  onChangeText={(txt) => { _username = txt;}}/>
              </View>
              <View style={{paddingLeft: 5, justifyContent: 'center', alignItems:'center',flexDirection: 'row', flex: 1, borderBottomColor: 'rgb(162,27,70)',borderWidth:0, borderBottomWidth: 2, height: windowHeight/12}}>
