...
import {
  ...
  StyleSheet,Text,  
  StatusBar,  
  View, Image, Button, Alert, TextInput,TouchableHighlight
} from 'react-native';
        ...
        <Image style ={styles.container}
          ...
          <View style={{flex: 2,  alignItems: 'center', justifyContent: 'center'}}>
              ...
              <View style={styles.signInView}>
                  <Button onPress={() => 
                    this.logIn()} title='Sign In' color='#841584' accessibilityLabel='Ok, Great!'/>      
              </View>
              ...
              <View style={[styles.fbLoginView,{backgroundColor: 'transparent'}]}>
                  <TouchableHighlight underlayColor={'transparent'} activeOpacity={0.5} style={{flex:1}} onPress={onSignUp}>
              ...
              <View style={[styles.signupView,{flexDirection: 'row', flex:1}]}>
                <Text style={{textAlign: 'center', color: 'white', flex:5}}>Don't you have an account?</Text>
                <View style={{flex:3}}>
                <Button onPress={() => 
                    navigate('Register_ViewController')} title='Sign Up' color='transparent' accessibilityLabel='Ok, Great!'/>      
                </View>
              </View>
          </View>
        </Image>
