...
class SH_Image extends PureComponent {
  static propTypes = {
    ...RNImage.propTypes,
  };
  ...
  createTransformedProps(props) {
    ...
    if (Platform.OS === 'android' && !isValidSource(source)) {
      ...
      transformedProps.source = defaultSource || require('./img/transparent.png');
...
const AnimatedImage = connectAnimation(SH_Image);
const StyledImage = connectStyle('shoutem.ui.Image')(AnimatedImage);
export {
  StyledImage as SH_Image,
};
