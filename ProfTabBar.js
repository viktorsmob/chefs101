...
export default class ProfTabBar extends Component {
    ...
    render() {
                ...
                navs[i] = (
                    <TouchableHighlight
                        ...
                        <View style={styles.center}>
                            <Image style={[styles.navImage, this._stressPoint(child) ? styles.navImageChange : undefined]} resizeMode='cover' />
                        </View>
                    </TouchableHighlight>
                );
        ...
        var imgSrc;
        if(this.props.tabType == 'Profile')
        {
            switch(this.state.selectedIndex)
            {
                case 0:
                    imgSrc=require('./img/Category View Selected.png');
                    break;
                case 1:
                    imgSrc=require('./img/Promotions View Selected.png');
                    break;
                case 2:
                    imgSrc=require('./img/Review Selected.png');
                    break;
                case 3:
                    imgSrc=require('./img/Seller Info View Selected.png');
                    break;
            }
        }

        if(this.props.tabType == 'Search')
        {
            switch(this.state.selectedIndex)
            {
                case 0:
                    imgSrc=require('./img/Hashtags Selected.png');
                    break;
                case 1:
                    imgSrc=require('./img/Users Selected.png');
                    break;
            }
        }

        if(this.props.tabType == 'CategoryDetail')
        {
            switch(this.state.selectedIndex)
            {
                case 0:
                    imgSrc=require('./img/Grid View Selected.png');
                    break;
                case 1:
                    imgSrc=require('./img/List View Selected.png');
                    break;
            }
        }
        ...
        return (
            <View style={[styles.container,this.props.style]}>
                ...
                <View style={styles.nav}>
                    <Image style={styles.navBarImage} resizeMode={Image.resizeMode.stretch} source={imgSrc}>
                        {navs}
                    </Image>
                </View>
